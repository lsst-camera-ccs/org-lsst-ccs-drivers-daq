...
#include "org_lsst_ccs_daq_ims_DAQSourceChannel.h"
#include "Channel.h"
#include "ims/Source.hh"

using namespace IMS;

JNIEXPORT jint JNICALL Java_org_lsst_ccs_daq_ims_DAQSourceChannel_read
...
JNIEXPORT jint JNICALL Java_org_lsst_ccs_daq_ims_DAQSourceChannel_write
