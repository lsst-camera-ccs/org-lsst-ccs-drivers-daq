...
static const char ANNOUNCE[] = "\n"
                               "  Enter the Interface source editor. This editor is used to assign interface names. Input to the utility requires either one or two arguments. Where:\n" 
...
int main(int argc, char** argv)
 ...
 DSM::Interface interface(_partition(PARTITION));
