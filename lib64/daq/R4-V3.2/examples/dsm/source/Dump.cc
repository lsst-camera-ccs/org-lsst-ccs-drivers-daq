...
SourceEditor::Dump::Dump(Interface& interface, Shell& shell) : 
 Command(COMMAND),
...
void SourceEditor::Dump::process(int argc, const char** argv, int qualifier)   
 {
 ...
 if(qualifier == Shell::Value::CURRENT)
  ...
  SourceEditor::Current processor;
  ...
  SourceEditor::Pending processor;
...
static const char HELP[] = "\n" 
                           ...
                           "  ATCA location, network address and role assignment. The command takes no arguments, but\n"
...
void SourceEditor::Dump::help(int argc, const char** argv, int qualifier)   
 {
