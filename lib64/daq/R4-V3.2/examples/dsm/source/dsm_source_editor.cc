...
static const char ANNOUNCE[] = "\n"
                               "  Enter the Source editor. This editor is used to manage the RCE's source within a partition. Input to the utility requires either one or two arguments. Where:\n" 
...
int main(int argc, char** argv)
 ...
 SourceEditor::Shell shell(interface);
