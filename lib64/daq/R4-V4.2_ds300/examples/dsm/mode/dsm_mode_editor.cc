...
static const char ANNOUNCE[] = "\n"
                               "  Enter the Mode editor. This editor is used to establish the mode for the entire partition. Input to the utility requires either one or two arguments. Where:\n" 
                               "  If one argument  - The argument corresponds to the name of a valid partition whose mode is to be modified and defaults the network interface.\n"
...
int main(int argc, char** argv)
 ...
 ModeEditor::Shell shell(interface);
