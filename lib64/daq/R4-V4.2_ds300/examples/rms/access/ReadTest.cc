...
void Access::ReadTest::process(int argc, const char** argv, int constant)   
{
  ...
  DAQ::LocationSet targets = _parse_targets(argc-arg, (const char**)&argv[arg]);
...
static const char HELP[] = "read_test [-p] [-i] [-c cadence] [-u ucadence] <partition> <registers> [DAQ Locations]\n" \
