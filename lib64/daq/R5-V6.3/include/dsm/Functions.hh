...
#define MODE           DSI::Header::F3  // Return either current or pending mode
...
#define SET_MODE           DSI::Header::F11  // Assign mode
...
#define RESET_MODE         DSI::Header::F19  // Deassign mode
