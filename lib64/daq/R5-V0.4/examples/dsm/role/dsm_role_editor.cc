...
static const char ANNOUNCE[] = "\n"
                               "  Enter the Role editor. This editor is used to manage the role of the RCEs in a partition. Input to the utility requires either one or two arguments. Where:\n" 
