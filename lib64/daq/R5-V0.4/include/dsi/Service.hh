...
protected:
  Service(const Address&, const Location& location,  const char* interface)                 throw (IPV4::Exception);
  Service(const Address&, const Location& location,  const char* interface, IPV4::Buffer*)  throw (IPV4::Exception);
protected:
  Service()               = delete;
